...
export class TrackerEditorModal {
    ...
    createModal() {
        ...
        saveButton.className = 'tracker-modal-save-button';
        ...
        cancelButton.className = 'tracker-modal-cancel-button';
    ...
    close(isSave) {
        if (this.modal) {
            ...
            if (isSave) {
                ...
                // Resolve with the original tracker
                this.resolvePromise(this.originalTracker);
            }
        }
    }
}
